  ...
  return (
    <section className="notion-page">
      ...
      <form onSubmit={submit} className="notion-form">
        <input
          className="notion-input title-input"
          required
        ...
        {form.category === 'ID Cards' && (
          <div
            className="form-row"
            style={{ backgroundColor: '#eef6ff', padding: '10px', borderRadius: '5px', marginTop: '10px' }}
          >
            <div className="input-group">
              <label>Card Type</label>
              <input
                className="notion-input"
                placeholder="e.g., Student ID, Office ID"
                value={form.cardType}
        ...
        {form.status === 'Found' && form.sensitivity === 'High' && (
          <div
            className="form-row"
            style={{ backgroundColor: '#fff3cd', padding: '10px', borderRadius: '5px', marginTop: '10px' }}
          >
            <div className="input-group">
              ...
              <input
                ...
                value={form.bcvQuestion}
                onChange={e => setForm({ ...form, bcvQuestion: e.target.value })}
              />
            </div>
            ...
            <div className="input-group">
              ...
              <input
                ...
                type="password"
                placeholder="Answer..."
                value={form.bcvAnswer}
                onChange={e => setForm({ ...form, bcvAnswer: e.target.value })}
              />
            </div>
          </div>
        )}
